...
This project includes a small drift detection API that reads reference features and recent prediction feature logs from GCS
and generates an Evidently HTML drift report.
